...
# === Load Data ===
output_dir = "/Users/basak/Documents/VS Code/EdTech/EdTech/data/processed/"
daily_file = os.path.join(output_dir, "global_borda_daily.csv")
monthly_file = os.path.join(output_dir, "global_borda_monthly.csv")
